...
class Boggle():
    ...
    def make_board(self): 
        ...
        # make five rows
        for y in range(5):
            # ascii_uppercase is a pre-initialized string used as string constant. 
            # In Python, string ascii_uppercase will give the uppercase letters 
            # ‘ABCDEFGHIJKLMNOPQRSTUVWXYZ’.
            # each row has five letters that are randomly selected
